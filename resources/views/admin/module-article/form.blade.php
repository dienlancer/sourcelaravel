...
$inputArticleId          =   '<input type="text" class="form-control" name="article_id"   id="article_id"       value="'.@$arrRowData['article_id'].'">'; 
    ...
    <div class="portlet-body form">
        <form class="form-horizontal" role="form" enctype="multipart/form-data">
            <div class="form-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <label class="col-md-3 control-label"><b>ArticleID</b></label>
                        <div class="col-md-9">
                            <?php echo $inputArticleId; ?>
                            <span class="help-block"></span>
                        </div>
                    </div>   
                    <div class="form-group col-md-6">
